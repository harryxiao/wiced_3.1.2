...
#define WIFI_COMMANDS \
    ...
    { (char*) "get_noise",               get_noise,               0, DELIMIT, NULL, (char*) "",                                           (char*) "Get PHY noise after successful TX"},\
    { (char*) "get_ap_info",             get_ap_info,             0, DELIMIT, NULL, (char*) "",                                           (char*) "Get AP information"}, \
    { (char*) "get_access_category_parameters_sta", get_access_category_parameters_sta, 0, DELIMIT, NULL, (char*) "",                     (char*) "Get access category parameters for STA"}, \
    { (char*) "get_associated_sta_list", get_associated_sta_list, 0, DELIMIT, NULL, (char*) "",                                           (char*) "Get list of associated clients"}, \
    ...
    { (char*) "get_rate",                get_rate,                0, DELIMIT, NULL, (char*) "",                                           (char*) "Get current rate."},\
    ...
    { (char*) "join_specific",           join_specific,           2, DELIMIT, NULL, (char*) "<ssid> <bssid> <channel> <open|wep|wpa_aes|wpa_tkip|wpa2|wpa2_tkip> [key] [ip netmask gateway]", (char*) "Join specified AP. DHCP assumed if no IP address provided"}, \
    ...
    { (char*) "set_legacy_rate",         set_legacy_rate,         1, DELIMIT, NULL, (char*) "<1|2|5.5|6|9|11|12|18|24|36|48|54>",         (char*) "Set legacy (CCK/OFDM) rate on PHY"},\
    { (char*) "set_mcs_rate",            set_mcs_rate,            1, DELIMIT, NULL, (char*) "<MCS Index> <Override MCS only>",            (char*) "Set MCS rate on PHY"},\
    { (char*) "disable_11n",             disable_11n,             0, DELIMIT, NULL, (char*) "",                                           (char*) "Disable 11n mode operation"},\
    { (char*) "enable_11n",              enable_11n,              0, DELIMIT, NULL, (char*) "",                                           (char*) "Enable 11n mode operation"},\
    ...
    { (char*) "set_listen_interval",     set_listen_interval,     1, DELIMIT, NULL, (char*) "<listen interval> <time unit>",              (char*) "Set listen interval in time unit 0 = Beacon Intervals. 1 = DTIM Intervals"}, \
    ...
    { (char*) "test_join_specific",      test_join_specific,      2, DELIMIT, NULL, (char*) "<ssid> <bssid> <channel> <open|wep|wpa_aes|wpa_tkip|wpa2|wpa2_tkip> [key] [ip netmask gateway] <iterations>", (char*) "Test joining an AP. DHCP assumed if no IP address provided"}, \
...
wiced_result_t deauth_all_associated_client_stas( wwd_dot11_reason_code_t inReason );
