...
#define WPS_COMMANDS \
    ...
    { (char*) "join_wps_specific",  join_wps_specific, 0, DELIMIT, NULL, (char*) "[pin] [<ip> <netmask> <gateway>]", (char*) "Join a specific WLAN using WPS PIN mode"}, \
    { (char*) "scan_wps",  scan_wps, 0, DELIMIT, NULL, (char*) "", (char*) "Scan for APs supporting WPS"}, \
